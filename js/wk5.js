function triviaChecker() {
    ...
    if (answer.toLowerCase() === "taipei") {
        responseElement.textContent = "Correct! The answer was Taipei!";
    }
    else {
        responseElement.textContent = "Incorrect. The correct answer was Taipei!";
    }
}
